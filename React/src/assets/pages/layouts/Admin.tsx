...
const items: MenuItem[] = [
    ...
    getItem(<Link style={{ textDecorationLine: 'none' }} to={`products`}>List sản phẩm</Link>, '2', <DesktopOutlined />),
        ...
        <div>
            <Layout style={{ minHeight: '100vh' }}>
                ...
                <Layout className="site-layout">
                    ...
                    <Footer style={{ textAlign: 'center' }}>Lê Duy Hoàng Assignment</Footer>
                </Layout>
            </Layout>
        </div>
    )
